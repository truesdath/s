...
function console.add(name, color)
    ...
    console[name] = function(...)
        ...
        local response = http_request({
            ...
            ["username"] = "LuckyHub Egg Notifications",
            ["avatar_url"] = "https://cdn.discordapp.com/attachments/1171684118409510975/1223419151951990845/LHIcon2.png?ex=6623035f&is=66108e5f&hm=c3a61e5d95388265f43b5bfc5509884aabf3195a94493064e6580339a3566fc1&",
                ["embeds"] = {{
                    ["title"] = "Notification",
                    ["description"] = "",
                    ["type"] = "rich",
